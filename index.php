...
if (getenv("REMOTE_ADDR") != "177.142.180.77" && getenv("REMOTE_ADDR") != "189.48.24.9") {
    echo "acesso negado";
    die();
}
...
define("TITLE", "Estilo Carioca | ");
define("TITLE_LOJA", "Estilo Carioca");
define("CEP_REMETENTE", "22780-084");
define("EMAIL_PAYPAL", "rodrigo@estilocarioca.com.br");
define("EMAIL_MOIP", "rodrigo@estilocarioca.com.br");
define("EMAIL_DISPATCHER", "contato@estilocarioca.com.br");
...
define("OG_TITLE", "Loja - estilocarioca.com.br");
define("OG_TYPE", "product");
define("OG_SITE_NAME", "estilocarioca.com.br");
define("OG_DESCRIPITION", "");
define("OG_EMAIL", "contato@estilocarioca.com.br");
...
$_SERVER['EMAIL_IMG_FOLDER'] = "http://www.estilocarioca.com.br/emails/images";
