...
<HTML>
    <HEAD>
        ...
        <meta name="Generator" content="Maria de Barro Acessórios Femininos LTDA - www.mariadebarro.com.br" />
        <style type=text/css>
    ...
    <BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
            ...
            <TR>
                <TD valign=top class=cp>
                    <DIV ALIGN="left">
                        ...
                        <li>Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde se encontra o cádigo de barras.<br>
            ...
            <TBODY>
                <TR>
                    <TD class=ct width=666>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/6.png" width=665 border=0>
                    </TD>
                </TR>
                <TR>
                    <TD class=ct width=666>
        ...
        <table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
            <tr>
                <td width=41>
                    <IMG SRC="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/logo_empresa.png">
                </td>
        ...
        <table cellspacing=0 cellpadding=0 width=666 border=0>
            <tr>
                <td class=cp width=150> 
                    <span class="campo">
                        <IMG src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/logocaixa.jpg" width="150" height="40" border=0>
                    </span>
                </td>
                <td width=3 valign=bottom>
                    <img height=22 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/3.png" width=2 border=0>
                </td>
...
<?php echo $dadosboleto["linha_digitavel"] ?>
            ...
            <tbody>
                <tr>
                    <td colspan=5>
                        <img height=2 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=666 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class=ct valign=top width=7 height=13>
                        <img height=13 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/1.png" width=1 border=0>
                    </td>
                ...
                <tr>
                    <td class=cp valign=top width=7 height=12>
                        <img height=12 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/1.png" width=1 border=0>
                    </td>
                ...
                <tr>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td><td valign=top width=268 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=268 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=156 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=156 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=34 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=34 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=53 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=53 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=120 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=120 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=113 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=113 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=72 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=72 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=132 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=132 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=134 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=134 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=180 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=180 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                ...
                <tr>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0></td>
                    <td valign=top width=113 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=113 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                    ...
                    <td valign=top width=112 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=112 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=659 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=659 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
...
<?php echo $dadosboleto["demonstrativo1"] ?><br>
        ...
        <table cellspacing=0 cellpadding=0 width=666 border=0>
            ...
            <tbody>
                ...
                <tr>
                    <td class=ct width=666><img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/6.png" width=665 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=472 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=472 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                <tr>
                    ...
                    <td class=ct valign=top width=133 height=13>N&ordm; documento</td>
                    <td class=ct valign=top width=7 height=13> 
                        <img height=13 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/1.png" width=1 border=0>
                    </td>
                ...
                <tr>
                    ...
                    <td class=cp valign=top width=7 height=12>
                        <img height=12 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/1.png" width=1 border=0></td>
                    ...
                    <tr>
                        ...
                        <td valign=top width=133 height=1>
                            <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=133 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                        </td>
                        <td valign=top width=62 height=1>
                            <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=62 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                        </td>
                        ...
                        <td valign=top width=102 height=1>
                            <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=102 border=0>
                        </td>
                        <td valign=top width=7 height=1>
                            <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                        </td>
        ...
        <table cellspacing=0 cellpadding=0 border=0>
            <tbody>
                ...
                <tr>
                    ...
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=75 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=31 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=31 border=0>
                    </td>
                    <td valign=top width=7 height=1> 
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=83 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=83 border=0>
                    </td>
                    <td valign=top width=7 height=1> 
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=43 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=43 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    <td valign=top width=103 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=103 border=0>
                    </td>
                    <td valign=top width=7 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=7 border=0>
                    </td>
                    ...
                    <td align=right width=10>
                        <table cellspacing=0 cellpadding=0 border=0 align=left>
                            <tbody> 
                                ...
                                <tr> 
                                    <td valign=top width=7 height=1>
                                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=1 border=0>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <tbody>
                <tr>
                    <td valign=top width=666 height=1>
                        <img height=1 src="<?php if( strlen(SOURCE) > 0 ) echo '/' . SOURCE; ?>/application/controllers/boletophp-master/imagens/2.png" width=666 border=0>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
            <TBODY>
                <TR><TD vAlign=bottom align=left height=50><?php fbarcode($dadosboleto["codigo_barras"]); ?> </TD></tr>
            </tbody>
        </table>
        <TABLE cellSpacing=0 cellPadding=0 width=666 border=0>
            <TR>
