...
<html>
    ...
    <body text="#000000" bgColor="#ffffff" topMargin="0" rightMargin="0">
            ...
            <tr>
                <td valign="top" class="cp">
                    <div ALIGN="left">
                        ...
                        <li>Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens mínimas à esquerda e á direita do formulário.<br>
            ...
            <tbody>
                <tr>
                    <td class="ct" width="666">
                        <img height="1" src="<?php if (strlen(SOURCE) > 0) echo '/' . SOURCE; ?>/imagens/6.png"" width="665" border="0"/>
                    </td>
                </tr>
                <tr>
                    <td class="ct" width="666">
        ...
        <table width="666" cellspacing="5" cellpadding="0" border="0" align=Default>
            <tr>
                <td width="41">
                    <img style="width: 60px;" src="<?php if (strlen(SOURCE) > 0) echo '/' . SOURCE; ?>/application/template/estilocarioca/assets/img/estilocarioca.png"">
                </td>
        ...
        <table cellspacing="0" cellpadding="0" width="666" border="0">
            <tr>
                <td class="cp" width="150"> 
                    <span class="campo">
                        <img src="/web-files/img/santander.png" width="140" height="37" border="0">
                    </span>
                </td>
                <td width="3" valign="bottom">
                    <img height="22" src="<?php if (strlen(SOURCE) > 0) echo '/' . SOURCE; ?>/imagens/3.png"" width="2" border="0">
                </td>
                ...
                <td width="3" valign="bottom">
                    <img height="22" src="/application/controllers/boletophp-master/imagens/3.png" width="2" border="0">
                </td>
            ...
            <tbody>
                <tr>
                    <td colspan="5">
                        <img height="2" src="/application/controllers/boletophp-master/imagens/2.png" width="666" border="0">
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    <td class="ct" valign="top" width="7" height="13">
                        <img height="13" src="/application/controllers/boletophp-master/imagens/1.png" width="1" border="0">
                    </td>
                    ...
                    <td class="ct" valign="top" width="3"4 height="13">
                        Espécie
                    </td>
                    <td class="ct" valign="top" width="7" height="13">
                        <img height="13" src="/application/controllers/boletophp-master/imagens/1.png" width="1" border="0">
                ...
                <tr>
                    <td class="cp" valign="top" width="7" height="12">
                        <img height="12" src="/application/controllers/boletophp-master/imagens/1.png" width="1" border="0">
                    </td>
                    ...
                    <td class="cp" valign="top"  width="3"4 height="12">
                        <span class="campo">
                ...
                <tr>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="298" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="298" border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="126" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="126" border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="3"4 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="3"4 border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="53" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="53" border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width=120 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=120 border="0">
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="ct" valign="top" width=134 height="13">
                        Vencimento</td><td class="ct" valign="top" width="7" height="13">
                        <img height="13" src="/application/controllers/boletophp-master/imagens/1.png" width="1" border="0">
                    </td>
                ...
                <tr>
                    ...
                    <td valign="top" width="113" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="113" border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="72" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="72" border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width=132 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=132 border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width=134 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=134 border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="180" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="180" border="0">
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top" width="112" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="112" border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top" width="659" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="659" border="0">
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table cellspacing="0" cellpadding="0" width="666" border="0">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ct" width="666">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/6.png" width="665" border="0">
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top" width=472 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=472 border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top" width=153 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=153 border="0">
                    </td>
                    <td valign="top" width="7" height="1"> 
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width=62 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=62 border="0">
                    </td>
                    <td valign="top" width="7" height="1"> 
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    ...
                    <td valign="top" width=82 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=82 border="0">
                    </td>
                    <td valign="top" width="7" height="1"> 
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
        ...
        <table cellspacing="0" cellpadding="0" border="0">
            <tbody>
                ...
                <tr>
                    ...
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7"5 border="0">
                    </td>
                    <td valign="top" width="7" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width="3"1 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="3"1 border="0">
                    </td>
                    <td valign="top" width="7" height="1"> 
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    <td valign="top" width=83 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=83 border="0">
                    </td>
                    <td valign="top" width="7" height="1"> 
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    ...
                    <td valign="top" width=123 height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width=123 border="0">
                    </td>
                    <td valign="top" width="7" height="1"> 
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="7" border="0">
                    </td>
                    ...
                    <td align="right" width=10>
                        <table cellspacing="0" cellpadding="0" border="0" align="left">
                            <tbody> 
                                ...
                                <tr> 
                                    <td valign="top" width="7" height="1">
                                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="1" border="0">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <tbody>
                <tr>
                    <td valign="top" width="666" height="1">
                        <img height="1" src="/application/controllers/boletophp-master/imagens/2.png" width="666" border="0">
                    </td>
                </tr>
            </tbody>
        </table>
