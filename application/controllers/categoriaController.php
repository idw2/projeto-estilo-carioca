...
Class Categoria extends Controller {
    ...
    function promocao() {
        ...
        $this->assign("title", TITLE . "Categoria | Junior");
    ...
    public function nilton_santos() {

        $categoria = "nilton-santos";
        ($categoria == "geral") ? $ctgr = null : $ctgr = $categoria;

        $this->assign("page", "nilton-santos");
        ...
        $this->assign("arr", $arr);
        $this->assign("language", LANGUAGE);
        $this->assign("title", TITLE . "Categoria | Nilton Santos");
        $this->view_tpl("categorias");
    }
    
    public function botafogo() {

        $categoria = "botafogo";
        ($categoria == "geral") ? $ctgr = null : $ctgr = $categoria;

        $this->assign("page", "botafogo");
    ...
    public function colares() {
        ...
        $this->assign("arr", $arr);
        $this->assign("language", LANGUAGE);
        $this->assign("title", TITLE . "Categoria | Colares");
        $this->view_tpl("categorias");
    }
    ...
    public function pulseiras() {
        ...
        $this->assign("arr", $arr);
        $this->assign("language", LANGUAGE);
        $this->assign("title", TITLE . "Categoria | Pulseiras");
        $this->view_tpl("categorias");
    }
    ...
    public function mais_vendidos() {
        ...
        $this->assign("arr", $arr);
        $this->assign("language", LANGUAGE);
        $this->assign("title", TITLE . "Mais Vendidos");
        $this->view_tpl("categorias");
    }

    function nossos_produtos() {
