...
Class Informacoes extends Controller {
    ...
    function quem_somos() {
        ...
        $this->assign("title", TITLE . "Quam somos");
    ...
    public function contato() {
        ...
        if ($_POST) {
            ...
            if ($erro == "") {
                ...
                $this->disparar_emailGoogleAppsHTML($vars["email"], FALSE, $emailsender, $assunto, $mensagemHTML, $comcopia);
    ...
    public function newsletter_footer() {
        ...
        if ($email == "") {
            echo "<span style='color: #0c1837'>* E-mail requerido!</span>";
        } else if (!preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $email)) {
            echo "<span style='color: #0c1837'>* E-mail inválido!</span>";
        } else {
            ...
            if ($model->existe_email_newsletter($email)) {
                ...
                echo "<span style='color: #0c1837'>* E-mail já cadastrado em nossa newsletter!</span>";
            } else {
                ...
                echo "<span style='color: #0c1837'>* Inscrição realizada com sucesso!</span>";
    ...
    public function avise_me_chegar() {
        ...
        if (!preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $email)) {
            ...
            if ($model->existe_email_newsletter($email)) {
                ...
                $avise_me["STATUS"] = 1;
                $avise_me["CODQUANTIDADE"] = $_POST["CODQUANTIDADE"];
