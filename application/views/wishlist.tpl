                                ...
                                {foreach item=lista_desejo from=$ld}  
                                    ...
                                    <tr>
                                        ...
                                        <td id="n_input">
                                            <table>
                                                <tr>
                                                    <td><span style="cursor: pointer;" class="minus" onclick="javascript:plus_wishlist2('{$url_checkout}{$lista_desejo->CODPRODUTO}&COMANDO=menos&CODLISTADESEJOS={$lista_desejo->CODLISTADESEJOS}&imposto={$imposto}&CODQUANTIDADE={$lista_desejo->CODQUANTIDADE}', '{$lista_desejo->CODLISTADESEJOS}');" title="Menos item"><i class="fa fa-minus-square"></i></span>&nbsp;</td>
                                                    ...
                                                    <td>&nbsp;<span style="cursor: pointer;" class="plus" onclick="javascript:plus_wishlist2('{$url_checkout}{$lista_desejo->CODPRODUTO}&COMANDO=mais&CODLISTADESEJOS={$lista_desejo->CODLISTADESEJOS}&imposto={$imposto}&CODQUANTIDADE={$lista_desejo->CODQUANTIDADE}', '{$lista_desejo->CODLISTADESEJOS}');" title="Mais item"><i class="fa fa-plus-square"></i></span></td>
                                                </tr>
                                            </table>                
                                        </td>
                                        {*                                                <td  id="preco_total_produto_{$lista_desejo->CODLISTADESEJOS}"> {if $lista_desejo->TOTAL eq ""}0,00{else}{$lista_desejo->TOTAL}{/if}</td>*}
                                        <td><span style="cursor: pointer;" onclick="javascript:del_row_wishlist('{$url_checkout}{$lista_desejo->CODPRODUTO}&CODQUANTIDADE={$lista_desejo->CODQUANTIDADE}')"><i class="fa fa-times"></i></span></td>
                                    </tr>
