...
<div class="tab-content">
            ...
            *}
            <div id="tableCielo" style="display: block;">
                ...
                <div class="cont-cartao">
                    ...
                    <div>
                        <input style="margin-bottom: 30px;" type="submit" value="Pagar" class="btn btn-default" onclick="javascript:cielo('{$CLIENT_HIDDEN}', '{$CODCADASTRO}', '{$CODENDERECO}', '{$language}');">
    ...
    <div id="tabs-3" class="tab-pane">
        ...
        <div class='form-group'>
            <button style="display:block;max-width:450px;margin: 0 auto;" type="button" id='confirm-payment-paypal' class='btn btn-default' onclick="javascript:paypal('{$CLIENT_HIDDEN}', '{$CODCADASTRO}', '{$CODENDERECO}', '{$language}');">PAGAR COM PAYPAL</button>
        </div>
    </div>
</div>
...
<img src="{$web_files}/img/assets/pagamento-moip.png" alt="Moip">
</div>
<div class="radio-block active">
<input type="radio" name='pgto' value='paypal' checked='true' class="radio-switch">
<img src="{$web_files}/img/assets/pagamento-paypal.png" alt="Paypal">
</div>
</form>*}
...
<div>
    ...
    <span class="LoaderFinale hide"><img src="{$web_files}/img/Loader.GIF" alt="Carregando..." title="Carregando..." border="0" style="width: 25px;"/></span></div>
    <ul class="pager">
