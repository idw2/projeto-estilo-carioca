...
<html lang="pt-br">
    ...
    <head>
        ...
        <link href="{$web_files}/bootstrap-colorpicker-master/dist/css/bootstrap-colorpicker.min.css" rel="stylesheet">
        <link href="{$web_files}/bootstrap-colorpicker-master/src/css/docs.css" rel="stylesheet">
        
        {if $page != "index"}
            <!-- //CSS DO TEMA RESPONSIVO EM BOOTSTRAP -->
            <link href="{$web_files}/startbootstrap-sb-admin-1.0.2/css/sb-admin.css" rel="stylesheet">
            <link href="{$web_files}/startbootstrap-sb-admin-1.0.2/css/plugins/morris.css" rel="stylesheet">
        {/if}
