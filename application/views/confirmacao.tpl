    ...
    <div style="padding: 75px 0 140px 0; margin-top: 30px;" class="container">
        <div class="row">
            <div class="section-title">
                ...
                <p class="subtitle">Obrigado <b>{$dados['NOME']}</b> por adquirir nossos produtos!</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 ">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {if $forma_pgto == "boleto"}         
                                <a href="{$web_files}/produtos/boleto/pedido/{$CODPEDIDO}" target="_blank" class='btn btn-default' style='padding: 6px 8px;height: auto; background: #1f3c8a!important;line-height: auto; width: 350px; margin: 0 auto; display: block;'>
