<?php /* Smarty version Smarty-3.1.19, created on 2014-11-10 13:14:11
         compiled from "/home/maria951/public_html/homolog/application/views/descricao.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5460d64351e118_88172676',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5460d64351e118_88172676')) {function content_5460d64351e118_88172676($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/home/maria951/public_html/homolog/libraries/plugins/function.counter.php';
...
?>
                                        ...
                                        <?php }?>
                                        <li>
                                            <a href="<?php echo $_smarty_tpl->tpl_vars['fful']->value->FOTO_HLG;?>
" class="fancybox-gallery" rel="gallery"><img src="<?php echo $_smarty_tpl->tpl_vars['fful']->value->FOTO_IT;?>
...
?>    
                                    <li>
                                        <img src="<?php echo $_smarty_tpl->tpl_vars['fful']->value->FOTO_SM;?>
" alt="<?php echo $_smarty_tpl->tpl_vars['nome']->value;?>
" border="0" title="<?php echo $_smarty_tpl->tpl_vars['nome']->value;?>
" />
                                    </li>
                    ...
                    <div class="col-sm-7">
                        ...
                        <hr>
                        <h2 class="title-lg produto-preco"><?php if ($_smarty_tpl->tpl_vars['is_promocao']->value==1) {?><span class="price-through" style="position: relative; top: -2px; color: #9a9a9a; font-size: 14px; font-size: 1.4rem; font-weight: 400; line-height: 1;">R$ <?php echo $_smarty_tpl->tpl_vars['de']->value;?>
...
/img/Loader.GIF" alt="Carregando..." title="Carregando..."/>
                            </span>
                        <?php }?>
                    </div>
                </div>
...
">
                                                    ...
                                                    <?php }?>
                                                    <img src="<?php echo $_smarty_tpl->tpl_vars['promocao']->value->CROP268;?>
...
" border="0"/>
                                                    ...
                                                    <td>
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <?php echo $_smarty_tpl->tpl_vars['lista_desejo']->value->REFERENCIA;?>

                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <?php echo $_smarty_tpl->tpl_vars['lista_desejo']->value->PRECO;?>
...
/informacoes/programa-fidelidade" target="_blank" style="color: #df5d65; font-style: italic;">Saiba como funciona</a>
                                    ...
                                    <div class="text-right">
                                        <a href="/<?php echo $_smarty_tpl->tpl_vars['language']->value;?>
/conta/wishlist" class="btn-link">&raquo; Meus Desejos</a>
                                    </div>
                                </div>
                            </div>
                        <?php }?>
