<?php /* Smarty version Smarty-3.1.19, created on 2014-10-24 13:52:40
         compiled from "/home/maria951/public_html/novo/application/views/categorias.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_544a75c83f0b64_75112779',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544a75c83f0b64_75112779')) {function content_544a75c83f0b64_75112779($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 9999, null, array(), 0);?>
...
<?php }?>">Próxima »</a></li>
                    ...
                    <div class="form-inline page-controls-options">
                        <label>Mostrar por: <select name="selectPrductSort" id="selectPrductSort" class="form-control">
                                ...
                                <option value="preco_crescente" <?php if ($_smarty_tpl->tpl_vars['sort']->value=="preco_crescente") {?>selected<?php }?>>Preço: Menor para o maior</option>
                                <option value="preco_decrescente" <?php if ($_smarty_tpl->tpl_vars['sort']->value=="preco_decrescente") {?>selected<?php }?>>Preço: Maior para o menor</option>
                                <option value="nome_crescente" <?php if ($_smarty_tpl->tpl_vars['sort']->value=="nome_crescente") {?>selected<?php }?>>Listar por nome: A para o Z</option>
                                <option value="nome_decrescente" <?php if ($_smarty_tpl->tpl_vars['sort']->value=="nome_decrescente") {?>selected<?php }?>>Listar por nome: Z para o A</option>
