            ...
            <div class="col-lg-12 col-md-12">
                <div class="panel panel-default">    
                    <table class="table" style="font-size: 14px">
                        <tr>
                            <td>
                                <form class="navbar-form navbar-left" role="search" action="/{$language}/conta/meus-dados/" method="post">
                                    ...
                                    <p> 
                                        <label>{$cpf}</label>
                                        <input type="hidden" class="form-control" style="min-width: 47%" id="cpf" name="cpf" maxlength="70" value="{$cpf}" placeholder="CPF" readonly/>
                                    </p>
