        ...
        <div class="col-sm-6">
            <div class="auth-form-wrapper">
                ...
                <form name="form-autenticacao" id="form-autenticacao" class="" onsubmit="return false" method="post" >
                    ...
                    <p>
                        <button type="submit" class="btn btn-primary btn-primary-maria" name="enviar" onclick="javascript:autenticacao();" style="margin-right: 5px;">Entrar</button> <a href="/{$language}/conta/esqueceu_senha/">Esqueceu sua senha?</a>
