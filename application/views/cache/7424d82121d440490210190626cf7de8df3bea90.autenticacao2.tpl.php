...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5512ea658dd827_56210761',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5512ea658dd827_56210761')) {function content_5512ea658dd827_56210761($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
                            ...
                            <div class="col-sm-5 col-sm-push-1">
                                <div class="auth-form-wrapper">
                                    ...
                                    <form name="form-autenticacao" id="form-autenticacao" class="" method="post">
                                        ...
                                        <p>
                                            <button type="submit" class="btn btn-primary btn-primary-maria" name="enviar" style="margin-right: 5px;">Entrar</button> <a href="/en/conta/esqueceu-senha/">Esqueceu sua senha?</a>
