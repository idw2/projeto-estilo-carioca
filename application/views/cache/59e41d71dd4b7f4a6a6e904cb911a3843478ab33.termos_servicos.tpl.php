...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_544aa7d3cca955_37545278',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544aa7d3cca955_37545278')) {function content_544aa7d3cca955_37545278($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/homolog/pt/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/homolog/pt/html/termos-servicos">Termos de serviço</a></li>              
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/homolog/pt/html/termos_servicos" method="post">
                <div class="row">
