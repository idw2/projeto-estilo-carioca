...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_545a83a3100fb3_59335215',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545a83a3100fb3_59335215')) {function content_545a83a3100fb3_59335215($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
            ...
            <div class="navbar navbar-fixed-top" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                                                <li><strong style="display: inline-block; line-height: 50px; color: #df5d65;">Boa noite Maria de Barro!</strong></li>
    ...
    <div style="position: relative">
        <form class="navbar-form pull-right search-wrap" role="search" action="/homolog/pt/novos-produtos" method="post">
            <input type="search" name="search" id="search" onkeyup="javascript:sugestao(this.value);" class="form-control" placeholder="BUSCAR"/>
...
<div class="container">
    ...
    <h3 style="font-weight: 300;margin-top: 25px">Boa noite Maria de Barro,<br/><br/> 
