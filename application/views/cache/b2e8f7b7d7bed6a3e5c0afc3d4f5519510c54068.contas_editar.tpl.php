...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54b836c57ab162_01246786',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54b836c57ab162_01246786')) {function content_54b836c57ab162_01246786($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" method="post">
                ...
                <input type="text" class="form-control" style="max-width: 30%" id="tel" name="tel" maxlength="10" value="25647267" placeholder="Telefone" onkeypress="return formataNumDV(event, this, 9);"/>
                ...
                <p> 
                    ...
                    <input type="text" class="form-control" style="min-width: 47%" id="cpf" name="cpf" maxlength="70" value="066.465.884-90" placeholder="CPF"/>
                </p>
                ...
                <div class="updatePassword  hide ">
                    ...
                    <p><input type="text" class="form-control" style="min-width: 100%" id="lembrete" name="lembrete" maxlength="30" value="65 sem o ama" placeholder="Lembrete de senha"/></p>
                </div>
