...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54d4bf0b2c8ec3_46346922',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d4bf0b2c8ec3_46346922')) {function content_54d4bf0b2c8ec3_46346922($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Estilo Carioca | Política de Privacidade</title>
...
-->
    ...
    <body style="padding-top: 52px" class="theme-default">
        ...
        <section class="header" id="stt_logado_print">
            <header id="header" class="navbar navbar-fixed-top navbar-default" role="navigation">
    <div class="header-bar"></div>
    <div class="container">
        <div class="navbar-header">
            <a href="#" class="hamburger"><span></span></a>
            <a class="brand" href="http://www.estilocarioca.com.br/application/template/estilocarioca/">
        ...
        <nav class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="http://www.estilocarioca.com.br/application/template/estilocarioca/sobre">A Estilo Carioca</a>
                </li>
                <li class="">
                ...
                <li class="">
                    <a href="/pt/nilton-santos">Nilton Santos</a>
                                    ...
                                    <li>
                        <a href="/pt/conta/login-cadastro/" id="nav-login">Login</a>
                    </li>
                            </ul>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <p><strong>Pol&iacute;tica de privacidade Maria de Barro</strong></p>
