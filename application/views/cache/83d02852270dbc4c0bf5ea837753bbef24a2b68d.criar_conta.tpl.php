...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5447e957c7a3f4_04219932',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5447e957c7a3f4_04219932')) {function content_5447e957c7a3f4_04219932($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
            ...
            <div class="navbar navbar-fixed-top" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="/en/produtos/checkout/" id="nav-login">Login e Cadastro</a></li>
                        <li><a onclick="open_atendimento()" style="cursor: pointer;">Atendimento Online</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/en/produtos/checkout/">Wishlist</a></li>
                        <li>
        ...
        <div class="col-lg-12">    
            <div class="panel panel-default">    
                <table class="table" style="font-size: 14px">
                    ...
                    <tr>
                        <td>
                            <form class="navbar-form navbar-left" role="search" action="/en/produtos/criar_conta/email/Z3VzdGF2b0BtYXJpYWRlYmFycm8uY29tLmJy" method="post">
                                ...
                                <p>
                                    <input type="hidden" class="form-control" style="min-width: 47%" id="email" name="email" maxlength="70" value="gustavo@mariadebarro.com.br" placeholder="E-mail" readonly/>
                                </p>
                                <h4>E-mail: gustavo@mariadebarro.com.br</h4>
