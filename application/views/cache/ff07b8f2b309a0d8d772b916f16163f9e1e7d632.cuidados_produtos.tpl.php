...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_544aa7e4c7d3d0_86107779',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544aa7e4c7d3d0_86107779')) {function content_544aa7e4c7d3d0_86107779($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/homolog/pt/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/homolog/pt/html/cuidados-produtos">Cuidado com os Produtos</a></li>              
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/homolog/pt/html/cuidados_produtos" method="post">
                <div class="row">
