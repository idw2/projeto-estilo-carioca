...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54d4f6fd9bef13_02904017',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d4f6fd9bef13_02904017')) {function content_54d4f6fd9bef13_02904017($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Estilo Carioca | Promoções</title>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="brand" href="/en/">
                <img src="http://www.estilocarioca.com.br/application/template/estilocarioca/assets/img/estilocarioca.png" width="71" height="68">
            </a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="/en/nilton-santos">Nilton Santos</a>
                                    ...
                                    <li>
                        <a href="/en/conta/login-cadastro/" id="nav-login">Login</a>
                    </li>
                            </ul>
...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        ...
        <li  class="active" ><a href="/en/promocoes/">Promoções</a></li>                       
    ...
    <div class="container">
        ...
        <div class="row footer-content text-center">
            <p style="line-height: 22px;">
                ...
                <br>Atendimento ao cliente: contato@estilocarioca.com.br - 21 99576.5038 / 21 3283.5265
            </p>
        </div>
        <hr>
