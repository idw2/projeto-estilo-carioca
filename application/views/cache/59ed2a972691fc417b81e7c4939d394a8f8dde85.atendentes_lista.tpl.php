...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_543e974d3d1a10_28605460',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543e974d3d1a10_28605460')) {function content_543e974d3d1a10_28605460($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/pt/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/pt/admin/atendentes-lista">Lista</a></li>
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <br/>
            <a href="/pt/admin/cadastrar_atendente" class="btn btn-default navbar-btn"><i class="glyphicon glyphicon-user"></i> Cadastrar Atendente</a>
                    ...
                    <thead>
                        ...
                        <th>Situação</th>
                            ...
                            <tr >
                                ...
                                <td>M</td>
                                <td>
                                                                                                                                                                                            <a href="/pt/admin/status/0/rogerio@designlab.com.br"><span class="ico-default-eye " data-toggle="tooltip" title="Status"><i class="fa fa-eye"></i></span></a>
                                    <a href="/pt/admin/editar/rogerio@designlab.com.br"><span class="ico-default-edit" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></span></a>                             
                                    <a onclick="delete_produto('pt/admin/delete/rogerio@designlab.com.br')"><span class="ico-default-trash" data-toggle="tooltip" title="Excluir"><i class="fa fa-trash-o"></i></span></a>
                                </td>
                            </tr>
                        </tbody>
