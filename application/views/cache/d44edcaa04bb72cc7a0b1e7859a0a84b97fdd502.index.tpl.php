<?php /*%%SmartyHeaderCode:13397226375510633f11e870-25145313%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '13397226375510633f11e870-25145313',
  'variables' => 
  array (
    'web_files' => 0,
    'language' => 0,
  ...
  'unifunc' => 'content_5510633fbc36a2_81993978',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5510633fbc36a2_81993978')) {function content_5510633fbc36a2_81993978($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
...
<section class="section">
    <div class="container ">
        ...
        <div class="row ">
                    ...
                    <div class="thumb">
                        <div class="thumb-img ">
                            <a href="/en/junior/regata-mangueira">
                            <img src="/web-files/upload/thumbs/C6A577076FB03B38F8C832FFC7780C79/38CD8FCF7AD5C7A905139F0584338CC5.jpg" alt="Regata Mangueira" title="Regata Mangueira" width="312" height="312">
                            </a>
                        </div>
                        <div class="thumb-holder">
                            <div class="thumb-holder-out">
                                <div class="thumb-holder-in">
                                    <h2 class="price">R$ 159,00</h2>
                                    <p class="name">Junior<br/><span style="font-size: 18px !important;">Regata Mangueira</span></p>
                                    <a href="/en/junior/regata-mangueira" class="btn btn-default btn-buy">COMPRAR</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="thumb-holder">
                            <div class="thumb-holder-out">
                                <div class="thumb-holder-in">
                                    ...
                                    <p class="name">Junior<br/><span style="font-size: 18px !important;">Nilton Santos Manga Longa</span></p>
        ...
        <div class="row">
                        ...
                        <div class="thumbnail">
                            <div class="thumbnail-img">
                                <a href="/en/nilton-santos/camisa-masculina-3">
                                                                        ...
                                                                        <img src="/web-files/upload/thumbs/B57D9770DDC8E281B42EDDAA76528A61/6EEA28499DD6A26FBBDAE56CB6B8A332.jpg" alt="Camisa Masculina" title="Camisa Masculina"/>
                                </a>
                            </div>
                        ...
                        <div class="thumbnail">
                            <div class="thumbnail-img">
                                <a href="/en/junior/regata-mangueira">
                                                                            <span class="thumbnail-tag">Novo</span>
                                                                        <img src="/web-files/upload/thumbs/C6A577076FB03B38F8C832FFC7780C79/38CD8FCF7AD5C7A905139F0584338CC5.jpg" alt="Regata Mangueira" title="Regata Mangueira"/>
                                </a>
                            </div>
                            <div class="thumbnail-infos">
                                <a href="/en/junior/regata-mangueira">
                                ...
                                <a href="/en/junior/regata-mangueira">
                                    <div class="thumbnail-subtitle">Regata Mangueira</div>
                                </a>
                        ...
                        <div class="thumbnail">
                            <div class="thumbnail-img">
                                <a href="/en/nilton-santos/nilton-santos-manga-longa-1">
                                                                            <span class="thumbnail-tag">Novo</span>
                                                                        <img src="/web-files/upload/thumbs/AC529423034079FBCF30C78986410318/C0B5B61FF6B28BC796FB7C80BF9E9482.jpg" alt="Nilton Santos Manga Longa" title="Nilton Santos Manga Longa"/>
                                </a>
                            </div>
                            <div class="thumbnail-infos">
                                <a href="/en/nilton-santos/nilton-santos-manga-longa-1">
                                ...
                                <a href="/en/nilton-santos/nilton-santos-manga-longa-1">
                                    <div class="thumbnail-subtitle">Nilton Santos Manga Longa</div>
                                </a>
