<?php /*%%SmartyHeaderCode:132268409154ecf07cb595e6-24621053%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78358adce9d8b2e7fe5395dfba7ea40bd6c8e671' => 
    array (
      0 => '/home/estil450/public_html/application/views/admin/entrega_devolucao.tpl',
      1 => 1417206302,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '132268409154ecf07cb595e6-24621053',
  'variables' => 
  array (
    'language' => 0,
    'conteudo' => 0,
  ...
  'unifunc' => 'content_54ecf07d0383e7_48381298',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54ecf07d0383e7_48381298')) {function content_54ecf07d0383e7_48381298($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Estilo Carioca | Entrega e Devolvolução</title>
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #1f3c8a">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/pt/admin/welcome">Home</a></li>
                ...
                <li  class=""  style="background: #fff;"><a href="/pt/produtos/estoque-baixo" style="position: relative; color: #333">Estoque Baixo  <span style='background: #5F8DE2; display: inline-block; padding: 3px 10px; position: absolute; color: #fff; font-weight: bold; font-size: 19px; bottom: 3px; right: 7px;'>269</span> </a></li> 
                ...
                <li  class="active" ><a href="/pt/html/entrega-devolucao">Entrega e Devolução</a></li>              
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/pt/html/entrega_devolucao" method="post">
                <div class="row">
