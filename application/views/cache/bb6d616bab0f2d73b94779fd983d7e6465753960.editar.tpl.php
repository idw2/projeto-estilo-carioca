<?php /*%%SmartyHeaderCode:753789838545a9b4398f262-55660818%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb6d616bab0f2d73b94779fd983d7e6465753960' => 
    array (
      0 => '/home/maria951/public_html/homolog/application/views/admin/editar.tpl',
      1 => 1414697598,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '753789838545a9b4398f262-55660818',
  'variables' => 
  array (
    'language' => 0,
    'url_amigavel' => 0,
  ...
  'unifunc' => 'content_545a9b43d94452_00672938',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545a9b43d94452_00672938')) {function content_545a9b43d94452_00672938($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Maria de Barro | Editar Produto</title>
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/homolog/en/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/homolog/en/produtos/produtos-lista">Lista</a></li> 
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/homolog/en/produtos/editar/" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="/homolog/en/produtos/produtos_lista" class="btn btn-default navbar-btn"><i class="fa fa-reply">&nbsp</i> Voltar</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 text-left">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-left">
                        ...
                        <div class="thumbnail env-produto" style="margin: 0;"> 
                            ...
                            <div class="auto-price text-center"> R$ <span class="view-preco"></span></div>
                            <div class="auto-title text-center view-nome"></div>
                        ...
                        <div class="input-group input-group-lg" style="margin-bottom: 1%;">
                            <input type="text" class="form-control" id="de" name="de" placeholder="De" value=""  onkeypress="formataValor(event, this, 12);" onkeydown="backspaceFormataValor(event, this)"/>
                        </div>	
                        <br/>
                        <div class="input-group input-group-lg" style="margin-bottom: 1%;">
                            <input type="text" class="form-control" id="preco" name="preco" placeholder="Para" value="" onkeypress="formataValor(event, this, 12);" onkeydown="backspaceFormataValor(event, this)"/>
                        </div>	
                        <br/>
                        <div class="input-group input-group-lg" style="margin-bottom: 1%;">
                            <input type="text" class="form-control" id="preco" name="quantidade" placeholder="Quantidade" value="" onkeypress="return formataNumDV(event, this, 6);" />
                        </div>	
                        <br/>
                        <div class="input-group input-group-lg" style="margin-bottom: 1%;">
                        ...
                        <br/>
                        <div class="input-group input-group-lg" style="margin-bottom: 1%;">
                            <input type="text" class="form-control" id="referencia" name="referencia" maxlength="20" value="" placeholder="Referência"/>
                        </div>
                        <br/>
                        <div class="input-group input-group-lg" style="margin-bottom: 1%;">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <select name="categoria" class="form-control">
                                ...
                                <option value="conjuntos" selected>Conjuntos</option>
