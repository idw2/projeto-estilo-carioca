...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_545a8729efa0e5_47476503',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545a8729efa0e5_47476503')) {function content_545a8729efa0e5_47476503($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
            ...
            <div class="navbar navbar-fixed-top" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                                                <li><strong style="display: inline-block; line-height: 50px; color: #df5d65;">Prezada Maria de Barro!</strong></li>
    ...
    <div style="position: relative">
        <form class="navbar-form pull-right search-wrap" role="search" action="/homolog/pt/novos-produtos" method="post">
            <input type="search" name="search" id="search" onkeyup="javascript:sugestao(this.value);" class="form-control" placeholder="BUSCAR" autocomplete="off"/>
...
<div class="container">
    ...
    <h3 style="font-weight: 300;margin-top: 25px">Prezada Maria de Barro,<br><br> seu pagamento foi cancelado pelo PayPal.<br> 
        Verifique os dados informados e tente novamente.<br/>
    Acompanhe seu pedido na página <a href='/homolog/pt/conta/meus-pedidos'>Meus pedidos</a>.</h3>
