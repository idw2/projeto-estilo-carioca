...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_544932271e9557_98486013',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544932271e9557_98486013')) {function content_544932271e9557_98486013($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/pt/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/pt/html/programa-fidelidade">Programa de Fidelidade</a></li>              
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/pt/html/programa_fidelidade" method="post">
                <div class="row">
