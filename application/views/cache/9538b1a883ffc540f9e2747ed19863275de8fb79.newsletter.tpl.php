...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_54d2252a61aac1_14950843',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54d2252a61aac1_14950843')) {function content_54d2252a61aac1_14950843($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:og="http://ogp.me/ns#" xmlns:fb="http://www.facebook.com/2008/fbml">

    <head>
        <title>Maria de Barro | Acessórios femininos, anéis, brincos, colares, pulseiras, conjuntos, semijoiasInscrição de newsletter</title>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
            ...
            <script src="/web-files/js/vendor/modernizr.min.js"></script>
    ...
    <div class="container">
        ...
        <ul class="nav navbar-nav">
                            <li><a href="/en/conta/login-cadastro/" id="nav-login">Login e Cadastro</a></li>
                
            
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li><a href="/en/informacoes/newsletter">Newsletter</a></li>
                            <li>
                <a id="shopping-cart" href="/en/produtos/checkout/" class="btn-with-icon fa fa-shopping-cart">
...
<div class="container header-brand">
    <div class="row">
        <div class="col-sm-6 col-brand">
            <a href="/en/" class="brand"><img src="/web-files/img/logo.png" alt="Maria de Barro" border="0" title="" class="img-responsive"/></a>
        </div>
...
<nav class="navbar navbar-default" role="navigation">
    ...
    <ul class="nav navbar-nav">
        ...
        <li  class="" ><a href="/en/aneis/">Anéis</a></li>            
        <li  class="" ><a href="/en/brincos/">Brincos</a></li>           
        <li  class="" ><a href="/en/colares/">Colares</a></li>           
        <li  class="" ><a href="/en/pulseiras/">Pulseiras</a></li>                       
        <li  class="" ><a href="/en/conjuntos/">Conjuntos</a></li>                       
        <li  class="" ><a href="/en/promocoes/">Promoções</a></li>                       


    </ul>
    <div style="position: relative">
        <form class="navbar-form pull-right search-wrap" role="search" action="/en/novos-produtos" method="post">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <form class="navbar-form navbar-left" style="width: 100%" action="/en/informacoes/newsletter" method="post">
            ...
            <div class="row">
                <div class="col-sm-3 footer-group">
                    ...
                    <ul class="footer-lista">
                        <li><a href="/en/informacoes/quem-somos">Quem somos</a></li>

                            
                        <li><a href="/en/informacoes/politica-privacidade">Política de privacidade</a></li>
                        <li><a href="/en/informacoes/entrega-devolucao">Política de entrega</a></li>
                        <li><a href="/en/informacoes/procon-rj">Procon/RJ</a></li>
                    </ul>
                </div>
                <div class="col-sm-3 footer-group">
                    <h2 class="footer-title">Dúvidas</h2>
                    <ul class="footer-lista">
                        <li><a href="/en/informacoes/contato">Atendimento</a></li>
                        ...
                        <li><a href="/en/informacoes/perguntas-frequentes">Perguntas frequentes</a></li>
                        <li><a href="/en/informacoes/cuidados-produtos">Cuidados com os produtos</a></li>
                ...
                <div class="col-sm-3 footer-group">
                    ...
                    <ul class="footer-lista">
                        <li><a href="/en/novos-produtos/">Novos produtos</a></li>
                        <li><a href="/en/informacoes/promocoes">Promoções</a></li>
                        <li><a href="/en/informacoes/programa-vantagens">Programa de vantagens</a></li>
                        <li><a href="/en/informacoes/programa-fidelidade">Programa de fidelidade</a></li>
