...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_551af1e5645d51_25516937',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_551af1e5645d51_25516937')) {function content_551af1e5645d51_25516937($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="container" >
        <div class="row">
            <div class="section-title">
                ...
                <p class="subtitle">Veja como é rápido criar uma conta em nosso site</p>
            </div>
        </div>
        <div class="row">
        ...
        <div class="col-lg-12">    
            <div class="panel panel-default">    
                <table class="table" style="font-size: 14px">
                    ...
                    <tr>
                        <td>
                            <form class="navbar-form navbar-left" role="search" action="/pt/conta/criar-conta/email/HelveticaNeueLTStd-UltLt.otf" method="post">

                                                                    <div class="alert alert-success" role="alert"><strong>Atenção: </strong>Preencher todos os campos!</div>
                                                                <br/>
                                ...
                                <h4 style="position: relative">CPF 
                                    <span class="CPF-Ask hide">O cadastro do CPF é obrigatório para o envio da Nota Fiscal</span>
    ...
    <div class="container ">
        ...
        <div class="row footer-content">
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/pt/informacoes/trocas-e-devolucoes">Trocas e devoluções</a></li>
                    <li><a href="/pt/informacoes/termos-servicos">Termos de serviço</a></li>
                </ul>
            </div>
            <div class="col-sm-6 col-md-3">
        ...
        <div class="row footer-bottom">
            ...
            <p style="line-height: 1.8em;font-size: 1.2rem;">
                ...
                <br>&copy; Todos os direitos reservados - Rua Gazzi de Sá, nº17 - Lote 17 Quadra G , Barra da Tijuca / RJ - CEP: 22.793-210 
