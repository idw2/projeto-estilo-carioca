...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_542980e35b9d16_88745845',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542980e35b9d16_88745845')) {function content_542980e35b9d16_88745845($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Maria de Barro | Editar atendente</title>
 ...
 -->
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/pt/admin/editar/idesignerweb@live.com" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 text-left">
                        ...
                        <p><input type="text" class="form-control" id="nome" name="nome" maxlength="40" value="Rogerio Pontes" placeholder="Nome completo"/></p>
                        <h4>E-mail: idesignerweb@live.com</h4>
