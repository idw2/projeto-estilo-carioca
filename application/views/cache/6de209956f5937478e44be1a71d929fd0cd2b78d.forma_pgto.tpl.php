...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5460d6ab2d12a9_77976809',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5460d6ab2d12a9_77976809')) {function content_5460d6ab2d12a9_77976809($_smarty_tpl) {?><div class="row">
        ...
        <div class="tab-content">
                    ...
                    <form name="CieloForm" id="CieloForm" onsubmit="return false" class="form-cielo" style="display:block;max-width:450px;margin: 0 auto;text-align: left;">
                        <div id="tableCielo" style="display: block;">
                            ...
                            <div class="cont-cartao">
                                ...
                                <div>
                                    <input type="submit" value="Pagar" class="btn btn-primary" onclick="javascript:cielo('F2991EB694A15170FA748B7AD19B2049', '22385F07AFFF47C41EB0D197BEE2FB75', 'E207754F930EBED4E86D14972EB93B1C', 'pt');">
            ...
            <div id="tabs-2" class="tab-pane">
                ...
                <div class='form-group'>
                    ...
                    <br/>
                    <img src="/web-files/img/logocaixa.jpg" style="height: 40px; width: 150px;" border="0" alt="Caixa Economica Federal" title="Caixa Economica Federal"/>
                    <br/>
                ...
                <div class='panel panel-highlight'>
                    <div class="panel-body">
                        ...
                        <button type="buttom" class="btn btn-primary" name="enviar" onclick="javascript:boleto('F2991EB694A15170FA748B7AD19B2049', '22385F07AFFF47C41EB0D197BEE2FB75', 'E207754F930EBED4E86D14972EB93B1C', 'pt');">PAGAR COM BOLETO</button>
                    </div>
                </div>
                <div class='form-group'>
            ...
            <div id="tabs-3" class="tab-pane">
                ...
                <div class='form-group'>
                    <button type="button" id='confirm-payment-paypal' class='btn btn-primary' onclick="javascript:paypal('F2991EB694A15170FA748B7AD19B2049', '22385F07AFFF47C41EB0D197BEE2FB75', 'E207754F930EBED4E86D14972EB93B1C', 'pt');">PAGAR COM PAYPAL</button>
                </div>
            </div>
        </div>
