...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_542c3164bad2d2_13051511',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_542c3164bad2d2_13051511')) {function content_542c3164bad2d2_13051511($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Maria de Barro | Meus atendimentos</title>
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/pt/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/pt/atendimento/meus-atendimentos">Meus atendimentos</a></li> 
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel-default">
                <input type="hidden" name="codatendente" id="codatendente" value="53C5B67EAFF09914921F4FA74DA6427A"/>
