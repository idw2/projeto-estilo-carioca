...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_545b866b649785_90113847',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_545b866b649785_90113847')) {function content_545b866b649785_90113847($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="row">
        <div class="col-lg-12">
            <ul class="nav nav-tabs nav-justified navbar-checkout" role="tablist" style="font-size: 14px">
                ...
                <li class="active"><a href="/homolog/pt/conta/meus-dados/">Meus Dados</a></li>
                <li ><a href='/homolog/pt/conta/wishlist'>Wishlist</a></li>
        ...
        <div class="col-lg-12">    
            <div class="panel panel-default">    
                <table class="table" style="font-size: 14px">
                    <tr>
                        <td>
                            <form class="navbar-form navbar-left" role="search" action="/homolog/pt/conta/meus-dados/" method="post">
                                ...
                                <input type="text" class="form-control" style="max-width: 30%" id="tel" name="tel" maxlength="10" value="111111111" placeholder="Telefone" onkeypress="return formataNumDV(event, this, 9);"/>
                                <input type="text" class="form-control" style="max-width: 30%" id="ramal" name="ramal" maxlength="8" value="1111" placeholder="Ramal" onkeypress="return formataNumDV(event, this, 4);"/>
                                </p>
                                ...
                                <p> 
                                    <label>829.297.501-20</label>
                                    <input type="hidden" class="form-control" style="min-width: 47%" id="cpf" name="cpf" maxlength="70" value="829.297.501-20" placeholder="CPF" readonly/>
                                </p>
