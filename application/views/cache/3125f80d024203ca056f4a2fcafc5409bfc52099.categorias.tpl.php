...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5510768b693f04_41724250',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5510768b693f04_41724250')) {function content_5510768b693f04_41724250($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
...
<section class="pag-section">
    <div class="container">
        ...
        <div class="row">
                        ...
                        <div class="thumb">
                            <div class="thumb-img">
                                <a href="/en/junior/camisa-mangueira">
                                    <img src="/web-files/upload/thumbs/D1AD4CFF68975E9DC67F746259AAE380/AD6EA553B3B9C78F94DD67FD0A14AE72.jpg" alt="Camisa Mangueira" title="Camisa Mangueira" width="312" height="312">
                                </a>
                            </div>
                            <div class="thumb-holder">
                                <div class="thumb-holder-out">
                                    <div class="thumb-holder-in">
                                        <h2 class="price">R$ 159,00</h2>
                                        <p class="name">Junior<br/><span style="font-size: 18px !important;">Camisa Mangueira</span></p>
                                        <a href="/en/junior/camisa-mangueira" class="btn btn-default btn-buy">COMPRAR</a>
                                    </div>
                                </div>
                            </div>
                        </div>
