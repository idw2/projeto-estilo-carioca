...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5447e9d652bca1_54022231',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5447e9d652bca1_54022231')) {function content_5447e9d652bca1_54022231($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/en/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/en/pedidos/pedidos-lista">Lista</a></li>
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <a href="/en/pedidos/pedidos_lista" class="btn btn-default navbar-btn"><i class="fa fa-reply">&nbsp</i> Voltar</a>
                </div>
            </div>
