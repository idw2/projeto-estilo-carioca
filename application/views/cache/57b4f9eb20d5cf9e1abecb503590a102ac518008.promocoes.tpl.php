...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_544e913749ce57_44265330',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544e913749ce57_44265330')) {function content_544e913749ce57_44265330($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/homolog/en/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/homolog/en/html/promocoes">Promoções</a></li>
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="navbar-form navbar-left" style="width: 100%" action="/homolog/en/html/promocoes" method="post">
                <div class="row">
