<?php /*%%SmartyHeaderCode:1684657708544aa7ddd8bf85-43078415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a4bd29f1eadedc3d0f4395cf31ffb730053d61e' => 
    array (
      0 => '/home/maria951/public_html/homolog/application/views/admin/procon_rj.tpl',
      1 => 1409584468,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1684657708544aa7ddd8bf85-43078415',
  'variables' => 
  array (
    'language' => 0,
    'conteudo' => 0,
  ...
  'unifunc' => 'content_544aa7de180900_58974511',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_544aa7de180900_58974511')) {function content_544aa7de180900_58974511($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    ...
    <div class="collapse navbar-collapse" style="padding-bottom: 3%; background: #e25f66">
        ...
        <ul class="nav nav-stacked" style="font-size: 14px;">
            <li  class="" ><a href="/homolog/pt/admin/welcome">Home</a></li>
                ...
                <li  class="active" ><a href="/homolog/pt/html/procon-rj">PROCON-RJ</a></li>              
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form class="navbar-form navbar-left" style="width: 100%" action="/homolog/pt/html/procon_rj" method="post">
                <div class="row">
                ...
                <br/>
                <p><textarea class="form-control" rows="25" style="min-width: 100%" id="conteudo" name="conteudo"><p>Para DEN&Uacute;NCIAS e ORIENTA&Ccedil;&Otilde;ES <strong>ligue para 151</strong> e o hor&aacute;rio de funcionamento &eacute; de<strong> segunda &agrave; sexta de 07:00 &agrave;s 19:00</strong>.</p>
...
<p>A ouvidoria ter&aacute; o maior prazer em receber sua manifesta&ccedil;&atilde;o. Ela nos ajudar&aacute; a melhorar a qualidade dos servi&ccedil;os oferecidos.</p></textarea></p>
