<?php /*%%SmartyHeaderCode:205317883554ef73908282b1-44350910%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7f23a29e4b0f2d351d250fd8725d1b1c193629de' => 
    array (
      0 => '/home/estil450/public_html/application/views/admin/quem_somos.tpl',
      1 => 1417206318,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '205317883554ef73908282b1-44350910',
  'variables' => 
  array (
    'language' => 0,
    'conteudo' => 0,
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li  class="" ><a href="/en/admin/dashboard"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a></li>
            <li  class="" ><a href="/en/produtos/produtos-lista"><i class="fa fa-paper-plane"></i> Produtos</a></li> 
            <li  class="" ><a href="/en/produtos/estoque"><i class="fa fa-bars"></i> Estoque</a></li> 
            <li  class=""  ><a href="/en/produtos/estoque-baixo" style="position: relative; "><i class="fa fa-sort-alpha-asc"></i> Estoque Baixo </a></li>
            <li  class=""  ><a href="/en/produtos/avise-me" style="position: relative; "><i class="fa fa-bell"></i> Avise-me Quando Chegar </a></li>  
            <li  class="" ><a href="/en/produtos/mais-vendidos-site"><i class="fa fa-plus-circle"></i> Produtos Mais Vendidos</a></li> 
            <li  class="" ><a href="/en/conta/lista"><i class="fa fa-users"></i> Clientes</a></li>
            <li  class="" ><a href="/en/informacoes/newsletter-lista"><i class="fa fa-paper-plane"></i> Newsletter</a></li>
            <li  class=""  ><a href="/en/conta/aniversariantes" style="position: relative; "><i class="fa fa-users"></i> Aniversariantes </a></li>
            <li  class="" ><a href="/en/pedidos/pedidos-lista"><i class="fa fa-file-text"></i> Pedidos</a></li>
            <li  class="" ><a href="/en/pedidos/exportar"><i class="fa fa-expand"></i> Exportar Pedidos</a></li>
                
            <li  class=""  ><a href="/en/nota-fiscal/exportar" style="position: relative; "><i class="fa fa-expand"></i> Exportar Nota Fiscal</a></li>
            <li>
                ...
                <ul id="demo" class="collapse">
                    <li  class="active" ><a href="/en/html/quem_somos"><i class="fa fa-code"></i> Quem somos</a></li>
                    <li  class="" ><a href="/en/html/entrega-devolucao"><i class="fa fa-code"></i> Entrega e Devolução</a></li>              
                    <li  class="" ><a href="/en/html/termos-servicos"><i class="fa fa-code"></i> Termos de Serviço</a></li>              
...
<nav class="navbar navbar-default" role="navigation">
    ...
    <li  class=""  ><a href="/en/produtos/estoque-baixo" style="position: relative; ">Estoque Baixo </a></li> 
    ...
    <li  class="active" ><a href="/en/html/quem_somos">Quem somos</a></li>
...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="navbar-form navbar-left" style="width: 100%" action="/en/html/quem_somos" method="post">
                <div class="row">
                ...
                <br/>
                <p><textarea class="form-control" rows="25" style="min-width: 100%" id="conteudo" name="conteudo"><p style=\"text-align: justify;\"><span style=\"font-size: medium; font-family: arial, helvetica, sans-serif;\"><span style=\"font-size: small;\">A</span> <span style=\"color: #000000;\"><strong>Estilo Carioca</strong></span> <span style=\"font-size: small;\">&eacute; a uma loja de artigos esportivos online dedicada a todos que gostam de esporte.</span></span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;\">Tendo uma proposta variada e moderna com o objetivo de oferecer as nossas clientes os melhores&nbsp;</span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;\">produtos. &nbsp;</span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;\">Pois estamos sempre buscando as principais tend&ecirc;ncias esportivas.&nbsp;</span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;\">Nossa equipe trabalha e se dedica para que tudo seja feito com muito cuidado, sempre pensando&nbsp;</span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small;\">no&nbsp;melhor para nossos clientes,&nbsp;selecionando sempre as melhores op&ccedil;&otilde;es e, claro, sempre ouvindo&nbsp;</span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small;\">o&nbsp;que voc&ecirc;s querem encontrar em termo de esporte e tend&ecirc;ncias</span><span style=\"font-size: small; font-family: arial, helvetica, sans-serif;\">.&nbsp;</span><span style=\"font-size: small; font-family: arial, helvetica, sans-serif;\">Estamos sempre determinados em fazer o melhor para voc&ecirc;s e levar a melhor experi&ecirc;ncia de compra.&nbsp;</span><span style=\"font-family: arial, helvetica, sans-serif; font-size: small;\">Al&eacute;m da venda online e estamos localizada no Rio de Janeiro, mas entregamos para o todo o Brasil.</span></p></textarea></p>
