...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5460b9459cdf79_95734440',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5460b9459cdf79_95734440')) {function content_5460b9459cdf79_95734440($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">

    <head>
        <meta charset="UTF-8">
        <title>Maria de Barro | Quam somos</title>
            ...
            <div class="navbar navbar-fixed-top" role="navigation">
                <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                                                    <li><a href="/homolog/en/conta/login-cadastro/" id="nav-login">Login e Cadastro</a></li>
                                                
                        
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                                                <li>
                            <a id="shopping-cart" href="/homolog/en/produtos/checkout/" class="btn-with-icon fa fa-shopping-cart">
            ...
            <div class="container header-brand">
                <div class="row">
                    <div class="col-sm-6 col-brand">
                        <a href="/homolog/en/" class="brand"><img src="/homolog/web-files/img/logo.png" alt="Maria de Barro" border="0" title="" class="img-responsive"/></a>
                    </div>
    ...
    <ul class="nav navbar-nav">
        ...
        <li  class="" ><a href="/homolog/en/">Home</a></li>
        <li  class="" ><a href="/homolog/en/aneis/">Anéis</a></li>            
        <li  class="" ><a href="/homolog/en/brincos/">Brincos</a></li>           
        <li  class="" ><a href="/homolog/en/colares/">Colares</a></li>           
        <li  class="" ><a href="/homolog/en/pulseiras/">Pulseiras</a></li>                       
        <li  class="" ><a href="/homolog/en/conjuntos/">Conjuntos</a></li>                       
        <li  class="" ><a href="/homolog/en/promocoes/">Promoções</a></li>                       

    </ul>
    <div style="position: relative">
        <form class="navbar-form pull-right search-wrap" role="search" action="/homolog/en/novos-produtos" method="post">
...
<section class="pag-section pag-section-top">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <p style="text-align: justify;"><span style="font-size: medium; font-family: arial, helvetica, sans-serif;"><span style="font-size: small;">A</span> <span style="color: #000000;"><strong>Maria do Barro</strong></span> <span style="font-size: small;">&eacute; a uma loja de acess&oacute;rios online dedicada especialmente ao p&uacute;blico feminino.</span></span><span style="font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;">Tendo uma proposta variada e moderna com o objetivo de oferecer as nossas clientes os melhores&nbsp;</span><span style="font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;">produtos. &nbsp;</span><span style="font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;">Pois estamos sempre buscando as principais tend&ecirc;ncias em acess&oacute;rios.&nbsp;</span><span style="font-family: arial, helvetica, sans-serif; font-size: small; text-align: left;">Nossa equipe trabalha e se dedica para que tudo seja feito com muito cuidado, sempre pensando&nbsp;</span><span style="font-family: arial, helvetica, sans-serif; font-size: small;">no&nbsp;melhor para as nossas clientes,&nbsp;selecionando sempre as melhores op&ccedil;&otilde;es e, claro, sempre ouvindo&nbsp;</span><span style="font-family: arial, helvetica, sans-serif; font-size: small;">o&nbsp;que voc&ecirc;s querem encontrar em termo de acess&oacute;rios, que possam&nbsp;transformar diferentes estilos e&nbsp;</span><span style="font-size: small; font-family: arial, helvetica, sans-serif;">transformar qualquer look.&nbsp;</span><span style="font-size: small; font-family: arial, helvetica, sans-serif;">Estamos sempre determinados em fazer o melhor para voc&ecirc;s e levar a melhor experi&ecirc;ncia de compra.</span><span style="font-family: arial, helvetica, sans-serif; font-size: small;">Nossa loja vende somente online e estamos localizada no Rio de Janeiro, mas entregamos para o Brasil inteiro.</span></p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-3 footer-group">
                    ...
                    <ul class="footer-lista">
                        <li><a href="/homolog/en/informacoes/quem-somos">Quem somos</a></li>
                        
                        <li><a href="/homolog/en/informacoes/politica-privacidade">Política de privacidade</a></li>
                        <li><a href="/homolog/en/informacoes/entrega-devolucao">Política de entrega</a></li>
                        <li><a href="/homolog/en/informacoes/procon-rj">Procon/RJ</a></li>
                    </ul>
                </div>
                <div class="col-sm-3 footer-group">
                    <h2 class="footer-title">Dúvidas</h2>
                    <ul class="footer-lista">
                        <li><a href="/homolog/en/informacoes/contato">Atendimento</a></li>
                        <li><a href="/homolog/en/informacoes/trocas-e-devolucoes">Trocas e devoluções</a></li>
                        
                        <li><a href="/homolog/en/informacoes/termos-servicos">Termos de serviço</a></li>
                        <li><a href="/homolog/en/informacoes/perguntas-frequentes">Perguntas frequentes</a></li>
                        <li><a href="/homolog/en/informacoes/cuidados-produtos">Cuidados com os produtos</a></li>
                ...
                <div class="col-sm-3 footer-group">
                    ...
                    <ul class="footer-lista">
                        <li><a href="/homolog/en/novos-produtos/">Novos produtos</a></li>
                        <li><a href="/homolog/en/informacoes/promocoes">Promoções</a></li>
                        <li><a href="/homolog/en/informacoes/programa-vantagens">Programa de vantagens</a></li>
                        <li><a href="/homolog/en/informacoes/programa-fidelidade">Programa de fidelidade</a></li>
