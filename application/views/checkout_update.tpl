        ...
        <tr>
            ...
            <td style="text-transform: uppercase;">
                ...
                {if $lista_desejo->ALERT != ""}
                    <br/><span style="color: #8795ae; font-size: 10px; font-weight: bold;">{$lista_desejo->ALERT}</span>
                {/if}
            </td>
            ...
            <td><span onclick="javascript:del_row_wishlist('{$url_checkout}{$lista_desejo->CODPRODUTO}&CODQUANTIDADE={$lista_desejo->CODQUANTIDADE}')"><i class="fa fa-times"></i></span></td>
        </tr>
    {/foreach} 
    <tr>
